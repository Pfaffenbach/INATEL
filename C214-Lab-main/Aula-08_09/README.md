<h1 align="center">
    Aula-08/09 Teste Mock
  <br>
</h1>

<h4 align="center">Exercicio proposto para implementar um teste mock, tema escolhido foi informações de carros</a>.</h4>
...
## API
* POST (/create) - Inserir um novo carro
* GET (/list) - Mostrar todos os carros inseridos
* PUT (/update) - Upddate nas informações
* PATCH (/listUser) - Mostrar todos os carros inseridos
* DELETE (/delete) - Deletar informções existentes
