...
<h4 align="center">Exercicio proposto para implementar uma API Rest, tema escolhido foi uma biblioteca de Animes</a>.</h4>
...
## Requisitos
* /anime
* POST (/create) - Inserir um novo anime a biblioteca
* GET (/list) - Mostrar todos os animes inseridos na biblioteca
